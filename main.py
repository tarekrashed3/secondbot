...
BOT_TOKEN = "6292635526:AAHRVJr-wvElAnaqDsDMCWb4DdPpVWLaYxQ"
PAYMENT_CHANNEL = "@tvrekshibapayments" #add payment channel here including the '@' sign
OWNER_ID = 1020027694 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@cryptosiir"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
...
Per_Refer = 400 #add per refer bonus here
